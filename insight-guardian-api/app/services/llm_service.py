...
class LLMService:
    ...
    def extract_cv_info(cv_text: str, model: str = "gpt-4") -> dict:
        ...
        prompt_instructions = (
            ...
            "Return ONLY valid JSON, with no explanation, no Markdown, no code blocks, and no extra text. "
            "Do NOT wrap the JSON in triple backticks or any formatting. "
            "Return only the raw JSON object, with no leading or trailing whitespace or newlines.\n"
            "{\n"
            "  'candidate': {\n"
            "    'full_name': 'string',\n"
